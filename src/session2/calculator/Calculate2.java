...
interface Calculator {
	public String calculate(String left, String right) throws CalculateException;
}

class AdditionCalculator implements Calculator {
	@Override
	public String calculate(String left, String right) throws CalculateException {
		BigDecimal adaptee = new BigDecimal(left);
		return adaptee.add(new BigDecimal(right)).toString();
	}
}
...
class SubtractionCalculator implements Calculator {
	...
	public String calculate(String left, String right) throws CalculateException {
		BigDecimal adaptee = new BigDecimal(left);
		return adaptee.subtract(new BigDecimal(right)).toString();
	}
}
...
class MultiplicationCalculator implements Calculator {
	...
	public String calculate(String left, String right) throws CalculateException {
		BigDecimal adaptee = new BigDecimal(left);
		return adaptee.multiply(new BigDecimal(right)).toString();
	}
}
...
class DivisionCalculator implements Calculator {
	...
	public String calculate(String left, String right) throws CalculateException {
		...
		BigDecimal adaptee = new BigDecimal(left);
		return adaptee.divide(new BigDecimal(right)).toString();
	}
}
